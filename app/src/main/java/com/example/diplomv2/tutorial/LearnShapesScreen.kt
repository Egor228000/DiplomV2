    ...
    LazyColumn(
        ...
        items(1) {
            Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
                ...
                Text("🟦 Прямоугольник — похож на квадрат, но с длинными сторонами", fontSize = 20.sp)
                ...
                Text("✔ Все фигуры имеют форму: у круга нет углов, у треугольника — 3 угла, у квадрата — 4 одинаковые стороны.", fontSize = 16.sp)
                Text("✔ Фигуры можно встретить в повседневной жизни — они везде!", fontSize = 16.sp)
                Text("✔ Фигуры помогают понимать мир и создавать красивые рисунки.", fontSize = 16.sp)
