...
| Раздел | Описание |
|--------|----------|
| 🚂 **Математическая игра** | Решайте задачки и собирайте золотые звёздочки! Чем больше решишь — тем больше звезд! |
| 🚄 **Быстрые задачки** | Успейте решить максимум примеров! |
| 🏗️ **Фигурки и формы** | Собирайте геометрические фигуры! |
